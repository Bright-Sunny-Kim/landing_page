...
이 문서는 프로젝트의 현재 상태에 대한 유일한 기준 문서다. 다른 문서와 내용이 충돌하면 실제 운영 환경을 재검증한 후 이 문서를 우선 갱신한다.

## 기준 시점

- 문서 통합일: 2026-07-28
- 마지막 운영 기록: 2026-07-22
- 마지막 감사 자동화 기록: 2026-07-18
- 주의: 아래 상태는 기존 문서 통합 결과이며 운영 환경에 대한 신규 실측 결과가 아니다.
...
- `hyean-dskim.com`의 실제 현재 배포 대상이 Render인지 Ubuntu인지 운영 환경에서 다시 확인해야 한다.
...
1. [인수인계 체크리스트](../06-planning/handover-checklist.md)로 운영 환경을 실측한다.
2. 실측 결과로 이 문서의 운영 상태 표를 갱신한다.
3. [미완료 작업](../06-planning/open-items.md)의 P0 항목부터 처리한다.
